// Package user 提供 UserService 端口的 gRPC 远程实现（blog/rpg 微服务模式）。
package user
...
// grpcUserService 通过 gRPC 调用 user-service。
...
// NewGRPCUserService 连接 user-service gRPC 并返回 UserService 端口实现。
