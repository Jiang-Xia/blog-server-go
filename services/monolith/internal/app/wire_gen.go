...
func InitializeApp(cfgPath string) (*App, error) {
	...
	authService := auth.NewAuthService(userRepo, roleRepo, passwordChecker, v, store, configConfig, emailService)
	...
	grpcserverServer := provideUserGRPCServer(configConfig, profileService, v)
	app := NewApp(configConfig, hertz, zapLogger, client, rueidisClient, scheduledTaskRuntime, realtimeRuntime, module, activityNotifyRunner, grpcserverServer)
	return app, nil
}
