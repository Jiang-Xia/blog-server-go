...
func (_q *DeptQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *DeptQuery) FirstIDX(ctx context.Context) int {
...
func (_q *DeptQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *DeptQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *DeptQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *DeptQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
