...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			articletagstag.Table:          articletagstag.ValidColumn,
			...
			privilege.Table:               privilege.ValidColumn,
			...
			rolemenusmenu.Table:           rolemenusmenu.ValidColumn,
			roleprivilegesprivilege.Table: roleprivilegesprivilege.ValidColumn,
			roleusersuser.Table:           roleusersuser.ValidColumn,
			rpg.Table:                     rpg.ValidColumn,
			rpgactivity.Table:             rpgactivity.ValidColumn,
			rpgarticletip.Table:           rpgarticletip.ValidColumn,
			rpgguild.Table:                rpgguild.ValidColumn,
			rpgitemconfig.Table:           rpgitemconfig.ValidColumn,
			rpgleaderboardsnapshot.Table:  rpgleaderboardsnapshot.ValidColumn,
			rpglevelreward.Table:          rpglevelreward.ValidColumn,
			rpglotterypool.Table:          rpglotterypool.ValidColumn,
			rpgquest.Table:                rpgquest.ValidColumn,
			rpguserachievement.Table:      rpguserachievement.ValidColumn,
			rpguserbuff.Table:             rpguserbuff.ValidColumn,
			rpguserguildmember.Table:      rpguserguildmember.ValidColumn,
			rpguserinventory.Table:        rpguserinventory.ValidColumn,
			rpguserloadout.Table:          rpguserloadout.ValidColumn,
			rpguserlotteryrecord.Table:    rpguserlotteryrecord.ValidColumn,
			rpguserpet.Table:              rpguserpet.ValidColumn,
			rpguserquestprogress.Table:    rpguserquestprogress.ValidColumn,
			rpgusersociallog.Table:        rpgusersociallog.ValidColumn,
			...
			sensitivewordhit.Table:        sensitivewordhit.ValidColumn,
			sitenotification.Table:        sitenotification.ValidColumn,
