...
func InitializeApp(cfgPath string) (*App, error) {
	...
	module := rpg.NewModule(client, pusher, store, rueidisClient, userReader, articleReader, publisher, zapLogger)
	...
	registerDeps := provideRegisterDeps(healthHandler, rpgHandler, rpgAdminHandler, rpgProfileHandler, payHandler, payOrderHandler, service, userService, configConfig, store, zapLogger)
